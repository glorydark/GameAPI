...
import gameapi.extensions.gameLevel.GameLevelProvider;
import gameapi.extensions.locker.LockerEntry;
 ...
 */
@Future
public class GameLevelSystemManager {
    ...
    public GameLevelSystemManager(GameLevelProvider provider) {
