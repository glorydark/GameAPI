 ...
 */
public abstract class AdvancedFakeBlockContainerFormBaseImpl extends AdvancedFakeBlockContainerFormBase {
    ...
    public AdvancedFakeBlockContainerFormBaseImpl(String title, AdvancedChestFormType type) {
        this(title, type, false);
    }

    public AdvancedFakeBlockContainerFormBaseImpl(String title, AdvancedChestFormType type, boolean itemMovable) {
        super(title);
